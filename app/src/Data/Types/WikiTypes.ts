...
export interface Spell extends WikiObject {
  ...
  readonly Enchantments: [Maybe<string>, Maybe<string>, Maybe<string>];
  ...
  readonly RequiredSpells: [Maybe<string>, Maybe<string>, Maybe<string>];
  readonly PreSpells: [Maybe<string>, Maybe<string>, Maybe<string>];
